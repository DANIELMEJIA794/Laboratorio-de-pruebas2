...
// --------------------------------------------------------------------
	...
	copy($_FILES['ubicacion_hotel']['tmp_name'], "imagenes/" .$ubicacion_hotel) or die("No puede copiarse");
    copy($_FILES['caratula_hotel']['tmp_name'], "imagenes/" .$caratula_hotel) or die("No puede copiarse");
	copy($_FILES['caratula_lugar']['tmp_name'], "imagenes/" .$caratula_lugar) or die("No puede copiarse");
